...
- setting up evals when the user wants to evaluate but hasn't yet decided what to measure ("I have traces, how do I set up evals?"): references/setting-up-evals.md
